...
public class MyPageController {
    ...
    @GetMapping("{userId}")
    public ResponseEntity<List<ApplicationListGetResponse>> getApplicationList(@PathVariable Long userId) {
        List<ApplicationListGetResponse> response = mypageService.getApplicationList(userId);
